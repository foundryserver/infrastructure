# 1970-01-03 22:07:45 by RouterOS 7.16.2
...
/ip address
add address=10.90.90.2/24 comment="OOB IP Address" interface=ether8_oob \
    network=10.90.90.0
...
add address=10.20.10.29 name=monitor1.mgmt.local type=A
...
add address=192.168.0.9 name=monitor1.vm.local type=A
